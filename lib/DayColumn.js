...
var DaySlot = _react2.default.createClass({
  ...
  render: function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties(_props, ['min', 'max', 'step', 'now', 'selectRangeFormat', 'culture', 'timezone']);
    ...
    return _react2.default.createElement(
      ...
      _extends({}, props, {
        className: (0, _classnames2.default)('rbc-day-slot', _dates2.default.isToday(max, timezone) && 'rbc-today'),
        now: now,
        min: min,
        max: max,
        step: step
